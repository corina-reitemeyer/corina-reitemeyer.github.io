      ...
      <div className="flex min-h-screen flex-col items-center justify-center">
        <div className="max-w-3xl px-4">
          ...
          <p className="paragraph">
            I&apos;m a Full Stack Developer, with 6-7 years experience working
            as a Senior UX/UI Designer in the tech industry. My journey into
            ...
            in a fast-paced 17-week bootcamp at Dev Academy to specialise in
          ...
          <p className="paragraph">
            ...
            Reformer Pilates outside of coding, and I&apos;m a massive fan of
            cozy games!
          </p>
          <h3 className="mb-2 text-left text-2xl font-bold">Accolades:</h3>
          <p className="text-left text-lg">Best Awards: Bronze Award, 2018</p>
        </div>
      </div>
    </>
  )
