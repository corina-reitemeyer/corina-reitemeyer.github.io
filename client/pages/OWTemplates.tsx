...
export default function OWTemplates() {
  return (
    <>
      {/* 1. Hero */}
      <CaseStudyNavy
        intro="A feature built to speed up research setup. It ended up revealing how users utilised the studies."
        ...
        highlights={[
          {
            id: 'churn-signal',
            label: '~15% churn reduction',
            description:
              'early signal following launch suggested the feature was achieving its primary goal',
          },
          {
            id: 'ia-strategy',
            label: 'First feature under a new product strategy',
            description:
              'put the IA strategy into practice and validated the core hypothesis',
          },
          {
            id: 'product-intelligence',
            label: 'Unexpected product intelligence',
            description:
              'one details page generated insights that shaped leadership conversations about product direction',
          },
        ]}
      />
        ...
        items={[
          {
            ...
            images: [
              {
                id: 'ow-wireframes',
                src: '/images/process/ow-sketch.webp',
                alt: 'Thumbnail sketches',
                caption:
                  'Thumbnail sketches - ideating patterns after looking into competitor template libraries',
              },
              {
                id: 'ow-wireframes',
